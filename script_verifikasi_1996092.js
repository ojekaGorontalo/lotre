// ====================================================
// SCRIPT VERIFIKASI UID 1996092 + KIRIM KE KODULAR
// ====================================================

(function() {
    'use strict';

    const ALLOWED_UID = '1996092';
    ...
    // ---------- PASANG HOOK ----------
    hookGetUserInfo();
    console.log('✅ Script verifikasi UID aktif (hanya menerima 1996092 + kirim ke Kodular)');
