(function () {
  ...
  function sendStartupMotivationMessage() {
    const startupMessage = `🤖 <b>WINGO SMART TRADING BOT v6.5 - TREND FOLLOWER ONLY</b>\n\n` +
                          ...
                          `🧮 <b>STRATEGI:</b>\n` +
                          `• Trend Follower: prediksi berdasarkan hasil periode terakhir\n` +
                          `• Tidak ada override atau mode tambahan\n\n` +
  ...
  function resetBot() {
    ...
    const startupMsg = `🔄 <b>BOT DIRESET DAN DIAKTIFKAN (TREND FOLLOWER ONLY)</b>\n\n` +
                      `💰 Saldo: Rp 247.000\n` +
                      `🎯 Mulai dari Level 1\n` +
                      `🧮 Strategi: Trend Follower (ikuti hasil terakhir)\n` +
                      `📊 Martingale 7 Level\n\n` +
...
💰 Saldo awal: 247.000
🧮 Strategi: Trend Follower (mengikuti hasil periode terakhir)
📊 Martingale 7 Level
📡 Firebase aktif
